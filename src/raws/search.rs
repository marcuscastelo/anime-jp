...
mod tests {
    ...
    fn test_anime_name() {
        ...
        assert!(result.name().contains("One Piece"));
    }
    ...
    fn test_anime_raw_magnet() {
        ...
        assert!(result.uri().starts_with("magnet:?xt=urn:btih:"));
    }
    ...
    <tr class="default">
        ...
        let result = HttpScrapper::<Indexer>::new(MAGNET_REGEX.clone())
            .scrap_raw_data(html)
